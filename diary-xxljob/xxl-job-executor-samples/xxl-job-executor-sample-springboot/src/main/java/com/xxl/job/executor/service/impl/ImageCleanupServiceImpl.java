...
import com.xxl.job.executor.mapper.ImageCleanupMapper;
...
public class ImageCleanupServiceImpl implements ImageCleanupService {
    ...
    public ImageCleanupServiceImpl(ImageCleanupMapper imageCleanupMapper, OSS ossClient) {
        this.imageCleanupMapper = imageCleanupMapper;
        this.ossClient = ossClient;
    }

    @Override
    public ImageCleanupResult cleanupUnreferencedImages() {
        ...
        return new ImageCleanupResult(images.size(), deletedCount, failedCount);
    }
